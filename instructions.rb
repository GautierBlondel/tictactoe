...
#   (on ne vous demande pas de coder d'intelligence artificielle aujourd'hui…);

# - Le programme doit commencer en demandant le prénom de chaque joueur ;

# - Le plateau de jeu est composé de 9 cases, chacune désignée par sa position verticale 
#   (A, B ou C) suivie de sa position horizontale (1, 2 ou 3). 
...
# - Le programme doit détecter la fin de la partie. Si un joueur gagne, le jeu annonce son nom. 
...
#   (par ex : board affiché de façon stylée, compteur de parties, couleurs, etc.).